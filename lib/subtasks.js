...
Subtasks = (function(superClass) {
  ...
  Subtasks.prototype._taskTpl = "<li class='task'><input type='checkbox' /><textarea rows='1'></textarea><span class='icon-remove-task'>×</span></li>";

  Subtasks.prototype._addTpl = "<li class='add task'><span class='icon-add-task'>+</span><textarea rows='1' placeholder='添加子任务'></textarea></li>";
