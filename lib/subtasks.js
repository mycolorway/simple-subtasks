(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.simple['subtasks'] = factory(root["jQuery"],root["SimpleModule"]);
  }
...
Subtasks = (function(superClass) {
  ...
  Subtasks.prototype._bind = function() {
    ...
    })(this)).on('mousedown', '.task .link-cancel-edit', this._cancelEdit).on('mousedown', '.task .link-submit-edit', (function(_this) {
      return function(e) {
  ...
  Subtasks.prototype._renderLinks = function($content, content) {
    if (this.opts.autolink) {
      return $content.html(content.autolink({
        target: '_blank'
      }));
    } else {
  ...
  Subtasks.prototype.addTask = function(task) {
    ...
    this._renderLinks($task.find('.task-content'), task.desc);
    if (task.complete) {
