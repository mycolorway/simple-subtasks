...
Subtasks = (function(superClass) {
  ...
  Subtasks.prototype._addTpl = "<li class='add task'><span class='icon-add-task'>+</span><textarea rows='1' type='text' autofocus='autofocus' placeholder='添加子任务'></textarea></li>";
  ...
  Subtasks.prototype._bind = function() {
    ...
    })(this)).on('keyup', '.add.task textarea', (function(_this) {
      return function(e) {
        var $li, new_task;
        if (e.which !== 13) {
          return;
        ...
        _this.subtasks.find('.add.task textarea').val('').focus();
        return _this._triggerEvent('create', $li);
      };
    })(this)).on('keyup', '.task:not(.add) textarea', (function(_this) {
      return function(e) {
        var $input, $li, task;
        if (e.which !== 13) {
          return;
  ...
  Subtasks.prototype.addTask = function(task) {
    ...
    $li.insertBefore(this.add_textarea);
